...
import com.math.mstore.repository.ProductRepository;
...
public class ProductController {
	...
	@GetMapping("/{name}")
	public ResponseEntity<List<ProductModel>> GetByTitle(@PathVariable String name){
	...
	@PostMapping
	public ResponseEntity<ProductModel> productBody(@RequestBody ProductModel product){
	...
	@PutMapping
	public ResponseEntity<ProductModel> putBody(@RequestBody ProductModel product){
