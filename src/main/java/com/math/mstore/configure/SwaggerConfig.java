package com.math.mstore.configure;
...
public class SwaggerConfig {
	...
	public OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("MStore").description("Project E-Commerce - MStore")
						.version("v1.0.0").license(new License().name("https://www.linkedin.com/in/matheus-silva25/").url("http://springdoc.org"))
						.contact(new Contact().name("Matheus Silva").url("https://github.com/Matth998/MStore-BackEnd")
								.email("matheusoliveira.3125@gmail.com")))
				.externalDocs(new ExternalDocumentation().description("Github").url("https://github.com/Matth998"));
	}
